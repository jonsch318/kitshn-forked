...
enum class HomePageSectionEnum(
    ...
    SEASONAL_CHRISTMAS(
        title = Res.string.home_section_seasonal_christmas, weight = 2f, check = {
            it.dateTime.hour in 12..24

                    &&

                    (it.dateTime.month == kotlinx.datetime.Month.NOVEMBER && it.dateTime.dayOfMonth > 20 || it.dateTime.month == kotlinx.datetime.Month.DECEMBER)
    ...
    BREAKFAST(
        title = Res.string.home_section_enjoy_breakfast, weight = 1f, check = {
    ...
    LUNCH(
        title = Res.string.home_section_lunch_time, weight = 1f, check = {
    ...
    AFTERNOON(
        title = Res.string.home_section_baking, weight = 1f, check = {
    ...
    DINNER(
        title = Res.string.home_section_dinner, weight = 1f, check = {
            it.dateTime.hour in 17..21
        }, queryParameters = listOf(
            HomePageQueryParameters(
                keywords = listOf(
                    "dinner", "abendessen", "abendbrot", "hauptgericht", "main-dish", "main"
                )
            )
        )
    ),
    FAST(
        title = Res.string.home_section_fast_food, weight = 1f, check = {
    ...
    GO_TOS(
        title = Res.string.home_section_go_tos, weight = 0.8f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    NEW(
        title = Res.string.home_section_new_recipes, weight = 0.8f, queryParameters = listOf(
            HomePageQueryParameters(
                new = true
            )
        )
    ...
    UNCOOKED(
        title = Res.string.home_section_never_cooked, weight = 0.8f, queryParameters = listOf(
            HomePageQueryParameters(
                timescooked = 0
            )
        )
    ...
    FIVE_STARS(
        title = Res.string.home_section_five_stars, weight = 0.8f, queryParameters = listOf(
            HomePageQueryParameters(
                rating = 5
            )
        )
    ...
    MEXICAN(
        title = Res.string.home_section_mexican, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    AMERICAN(
        title = Res.string.home_section_american, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
                keywords = listOf(
                    "american",
                    "america",
    ...
    CHINESE(
        title = Res.string.home_section_chinese, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    INDIAN(
        title = Res.string.home_section_indian, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    ASIAN(
        title = Res.string.home_section_asian, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    GERMAN(
        title = Res.string.home_section_german, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    AUSTRIAN(
        title = Res.string.home_section_austrian, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
    ...
    VEGAN(
        title = Res.string.home_section_vegan, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
                query = "vegan"
            ), HomePageQueryParameters(
    ...
    VEGETARIAN(
        title = Res.string.home_section_vegetarian, weight = 0.5f, queryParameters = listOf(
            HomePageQueryParameters(
                query = "vegetarian"
            ), HomePageQueryParameters(
    ...
    BURGER(
        title = Res.string.home_section_burger, weight = 0.2f, queryParameters = listOf(
            HomePageQueryParameters(
                query = "burger"
            ), HomePageQueryParameters(
    ...
    NOODLES(
        title = Res.string.home_section_noodles, weight = 0.2f, queryParameters = listOf(
            HomePageQueryParameters(
                query = "nudeln"
            ), HomePageQueryParameters(
                foods = listOf(
    ...
    suspend fun toHomePageSection(
        keywordRepo: KeywordRepository, foodNameIdMapCache: FoodNameIdMapCache
    ): HomePageSection {
        val queryParametersList = mutableListOf<TandoorRecipeQueryParameters>()

        queryParameters.forEach { qp ->
            val keywordList =
                qp.keywords?.mapNotNull { name ->
                    keywordRepo.getByName(name)?.id
                } ?: listOf()
            ...
            if (qp.query == null && qp.new == null && qp.random == null && qp.rating == null && qp.timescooked == null && qp.sortOrder == null) if (keywordList.isEmpty() && foodList.isEmpty()) return@forEach
        ...
        return HomePageSection(
            this.title.key, queryParametersList
        )
    }
}